...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href ="productAdd.php"><button class="btn btn-primary mb-3 mt-3" >Add New Product</button> </a>
    ...
    <div class="card-header">
        <h2 class="card-title">List of products in <?php echo $categoryName;?> category </h2>
