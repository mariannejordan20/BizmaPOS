...
<body id="page-top">
    ...
    <div class="card-body">
        <div class="container-fluid">
            <div class="mb-3">
    <button onclick="location.href='athletegender.php'" class="btn btn-primary">Male</button>
    <button onclick="location.href='athletegender.php'" class="btn btn-primary">Female</button>
</div>
