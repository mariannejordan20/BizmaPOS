...
<form action="">
    ...
    <?php
                            $id = $_GET['id'];
                            $sql = "select * from stocksintry where ENCNum = ".$id;
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4 mt-3">
            <div class="form-group">
                ...
                <input type="text" name="ENCNum" class="shadow-sm form-control form-control-sm rounded" value="<?=$row['ENCNum']?>" readonly>
            </div>
        </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="DRNum" class="shadow-sm form-control form-control-sm rounded" value="<?=$row['DeliveryNumber']?>"readonly >
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group">
...
// Construct SQL query to fetch products with matching ENCNum
$sql = "SELECT ID, Barcode, Product, ItemType, Unit, Quantity, Costing, Price, Wholesale, Promo, DeliveryNumber, Supplier, Receiver, ItemSerial, ENCNum, TotalValRow
        FROM stocksintry
        WHERE ENCNum = '$id'
        ORDER BY Product";
...
<table class="table text-sm text-center table-bordered" style="font-size: 13px; font-weight:bold;" id="stockInListTable">
    ...
    <tbody id="productsTableBody" class="custom-font-size">
...
<script>
    ...
    var saveUrl = 'stocksInSaveSingle.php';
