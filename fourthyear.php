...
session_start();   
    ...
    $sql = "select ID, Student_ID, CONCAT(First_Name,' ', Last_Name) as StudName,Image,Blood_Type,Height,Weight,Status,Sex, Event , Age, Address, Phone, Course, Year_Level from athletes where Year_Level = 4";
...
<body id="page-top">
    ...
    <div class="card-header">
        <h3 class="card-title">List of Fourth Year Athletes</h3>
