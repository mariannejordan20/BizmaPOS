...
<body id="page-top">
    ...
    <div class="container-fluid m-0" style=" background: #11101D; white-space: nowrap; position:sticky; top:0; z-index:3;">
        <div class="row p-0">
            <div class="col-md-9 col-sm-6 col-12 p-0 ps-2  animate__fadeInLeft">
                <h2 class="text-start fw-bold text-light my-3">Sales</h2>
            </div>
            <div class="col-md-3 col-sm-6 col-12">
                <div class="d-flex justify-content-end">
                    <div class="float-end my-3 col-10 d-grid p-0">
                        <input type="search" id="searchBar" style="border-radius: 0; max-width: 100%;" class="form-control p-1" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
                    </div>
                    <div class="dropdown my-3 col-2 d-grid">
                        <button type="button" style="border-radius: 0; max-width: 100%;" class="btn btn-secondary dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                        </button>
                ...
                <div class="col-lg-4 col-12 p-1">
                    <div class="card w-100 float-end mb-2" style="border-radius: 0;">
                        ...
                        <div class="card-body p-1 pe-2 text-end" id="amnt">
                            <h1 class="m-0 mt-1 fw-bold"><?php echo $totalRetailValue; ?></h1>
                        </div>
                    ...
                    <div class="card w-auto" style="border-radius: 0;">
                        <div class="card-header p-2">
                            <h6 class="m-0">Details Panel: </h>
                        </div>
                        <div class="card-body px-1">
                            <div class="row">
                                <div class="col-12 mb-1">
                                    <h6 class="m-0" style="font-size:small ">Site Location</h6>
                                    <div style="cursor: pointer;" class="input-group" data-bs-toggle="modal" data-bs-target="#locationModal" style="border-radius:0">
                                        <span id="selectedUnitCode" class="input-group-text py-0 text-center d-grid px-0" style="border-radius:0; width: 80px;"></span>
                                        <input style="cursor: pointer;" id="selectedPname" type="text" class="form-control text-center p-0" readonly>
                                        <span class="input-group-text py-0" style="border-radius:0">></span>
                                    </div>
                                </div>
                                <div class="col-12 mb-1">
                                    <h6 class="m-0" style="font-size:small ">Customer</h6>
                                    <div style="cursor: pointer;" class="input-group mb-1" data-bs-toggle="modal" data-bs-target="#locationModal2" style="border-radius:0">
                                        <span id="selectedCcode" class="input-group-text py-0 text-center d-grid px-0" style="border-radius:0; width: 80px;"></span>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div style="cursor: pointer;" class="input-group mb-1" data-bs-toggle="modal" data-bs-target="#locationModal3" style="border-radius:0">
                                        <span id="selectedUserID" class="input-group-text py-0 text-center d-grid px-0" style="border-radius:0; width: 80px;"></span>
                        ...
                        <div class="card-footer px-4">
                            <div class="row">
                                <div class="col-12 d-grid w-100">
                                    <button class="btn btn-dark text-light p-3 fw-bold" style="border-radius: 0; max-width:100%;">Process Order Payment</button>
                                </div>
                            </div>
                        </div>
                    </div>
