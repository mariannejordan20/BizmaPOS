...
session_start();   
    ...
    $sql = "select ID, Student_ID, CONCAT(First_Name,' ', Last_Name) as StudName, Event , Age, Address, Phone, Course, Year_Level from athletes";
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href ="occupantsAdd.php"><button class="btn btn-success mb-3 mt-3" >Add New Athlete</button> </a>
    ...
    <div class="card-header">
        <h3 class="card-title">List of Athletes</h3>
