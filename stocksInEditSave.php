...
$query = mysqli_query($conn, "SELECT * FROM productsstocks WHERE Barcode = '$barcode' OR ProductID = '$productid' ");
...
if ($result && $result->num_rows > 0) {
    ...
    $stockInHistory = "INSERT INTO stockinhistory (Barcode,ProductID,DeliveryNumber,Shipper,Receiver, Product, Unit, Quantity, Costing, Price, Wholesale, Promo,Warranty, Categories,SubCategory, Seller, Supplier) VALUES ";
    $stockInHistory .= "('".$barcode."','".$productid."','".$deliverynumber."','".$shipper."','".$receiver."', '".$product."', '".$unit."', '".$serialQuantity."', '".$costing."', '".$price."', '".$wholesale."', '".$promo."','".$warranty."', '".$categories."','".$subcategory."' ,'".$seller."', '".$supplier."')";


    $stockInSerial = "INSERT INTO productsws (Barcode,ProductID,DeliveryNumber,Shipper,Receiver, Product,Unit, Quantity, Costing, Price, Wholesale, Promo,Warranty, Categories,SubCategory, Seller, Supplier) VALUES ";
    $stockInSerial .= "('".$barcode."', '".$productid."','".$deliverynumber."','".$shipper."','".$receiver."','".$product."','".$unit."', '".$serialQuantity."', '".$costing."', '".$price."', '".$wholesale."', '".$promo."','".$warranty."', '".$categories."','".$subcategory."' , '".$seller."', '".$supplier."')";
