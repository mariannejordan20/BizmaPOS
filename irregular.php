...
session_start();   
    ...
    $sql = "select ID, Student_ID, CONCAT(First_Name,' ', Last_Name) as StudName,Image,Blood_Type,Height,Weight,Status, Event ,Sex, Age, Address, Phone, Course, Year_Level from athletes where Status = 'Irregular'";
...
<body id="page-top">
    ...
    <div class="card-header">
        <h3 class="card-title">List of Irregular Athletes</h3>
