...
<body id="page-top">
 ...
 <?php
                        ...
                        ?>
                        <form action = "stocksInExpirySave.php" method="post" enctype ="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="Receiver" class="form-control form-control-sm rounded-0" value="<?php echo isset($_SESSION['Name']) ? $_SESSION['Name'] : ''; ?>"readonly>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" name="BatchNumber"  class="form-control form-control-sm rounded-0">
                                    </div>
                                </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="Quantity" class="form-control form-control-sm rounded-0"  min= "1" value="1" required>
            </div>
        </div>
