...
session_start();   
    ...
    $sql = "select ID, Student_ID, CONCAT(First_Name,' ', Last_Name) as StudName,Image,Blood_Type,Height,Weight,Status,Sex, Event , Age, Address, Phone, Course, Year_Level from athletes order by Last_Name";
