...
session_start();   
    ...
    $sql = "select ID, Seqcode, IDNumber,Barcode,CustomerName,Group,TermofPayment,VATTIN,ContactPerson, Address , Contact, Datee from customer order by CustomerName";
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">'.$result['Seqcode'].'</h5>
