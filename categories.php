                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mr-2 categories-section" style="background-color: #2f3742; border:none">
                                    ...
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <div class="input-group ml-2" style="max-width: 56%;"> <!-- Adjusted max-width for a shorter search bar -->
                                ...
                                <div class="col-md-5 ml-2 categories-section" style="background-color: #2f3742; border:none">
                                    ...
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <div class="input-group ml-2" style="max-width: 47%;"> <!-- Adjusted max-width for a shorter search bar -->
